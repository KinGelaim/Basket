// WebGL - Textures - Mips - Depth
// from https://webglfundamentals.org/webgl/webgl-3d-textures-mips-tri-linear.html
...
function main() {
  ...
  var image = new Image();
  requestCORSIfNotSameOrigin(image, "../mip-low-res-example.png")
