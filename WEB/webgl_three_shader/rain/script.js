...
class EffectCanvas {
  ...
  constructor(width, height, loader) {
    ...
    shaderData.uniforms.uTextureDropShine.value = loader.resources['img/shine.png'].texture;
    shaderData.uniforms.uTextureBackground.value = loader.resources['img/background.jpg'].texture;
    shaderData.uniforms.uTextureForeground.value = loader.resources['img/foreground.jpg'].texture;
    shaderData.uniforms.vTextureSize.value = [
      loader.resources['img/background.jpg'].texture.width,
      loader.resources['img/background.jpg'].texture.height,
    ];
