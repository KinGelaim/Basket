...
function initShaders() {
	...
	shaderProgram.useFixLightingUniform = gl.getUniformLocation(shaderProgram, "uUserFixLighting");
...
function drawScene() {
	...
	var fixLighting = document.getElementById("fixLighting").checked;
	gl.uniform1i(shaderProgram.useFixLightingUniform, fixLighting);
