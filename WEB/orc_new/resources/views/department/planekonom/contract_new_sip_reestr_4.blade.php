						...
						<div class="panel panel-default">
							...
							<div class="panel-body" style='overflow-y: auto;'>
								<ul class='nav nav-tabs'>
									<li class='active'>
										<a data-toggle='tab' href='#information'>Договор</a>
									</li>
									<li>
										<a data-toggle='tab' href='#params'>Параметры</a>
									</li>
									<li>
										<a data-toggle='tab' href='#big_deal'>Крупная сделка</a>
									</li>
								</ul>
								<div class='tab-content'>
												...
												<div class='row'>
													<div class="col-md-9">
														<div class='row'>
															...
															<div class="col-md-4 border-top" style='font-size: 9px;'>
																<div class="form-group">
									...
									<div id='big_deal' class='tab-pane fade'>
										<div class='row'>
											<div class="col-md-12">
