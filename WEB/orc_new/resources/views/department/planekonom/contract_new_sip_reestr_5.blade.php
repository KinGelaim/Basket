				...
				<div class="content">
					<form method='POST' action="{{route('department.ekonomic.create_sip_reestr')}}" file='true' enctype='multipart/form-data'>
						...
						<div class="row    ">
							...
							<div class="col-md-1  ">
								<div class="form-group">
									<button type='button' class="btn btn-primary" data-toggle="modal" data-target="#chose_counterpartie" style='margin-top: 15px;'>Выбрать</button>
								</div>
							</div>
							<div class="col-md-2  ">
								<div class="form-group">
						...
						<div class="row  ">
							...
							<div class="col-md-1  ">
								<div class="form-group">
									<label for='index_dep' style='font-size: 9px;'>Индекс подразд.</label>
							...
							<div class="col-md-2   ">
								<div class="form-group">
									<label for='date_save_contract_reestr' style='font-size: 9px;'>Дата сдачи Дог./Контр. на хранение</label>
							...
							<div class="col-md-1 ">
								<div class="form-group">
									<label for='sel6' style='font-size: 10px;'>Тип документа</label>
								...
								<div class='row'>
									<div class="col-md-9">
										...
										<div class='row'>
											<div class="col-md-4  ">
												<div class="form-group">
													<label id='label_date_registration_project_reestr' for='date_registration_project_reestr' style='font-size: 10px;'>{{ $reestr->application_reestr ? 'Дата регистрации заявки' : 'Дата регистрации проекта'}}</label>
						...
						<div class='row'>
							...
							<div class="col-md-7 ">
								...
								<div class="row">
									...
									<div class="col-md-2">
										<label for='days_reconciliation_reestr' style='font-size: 9px;'>Срок действия согласования крупной сделки</label>
									</div>
									<div class="col-md-2">
								...
								<div class="row">
									...
									<div class="col-md-2">
										<label for='count_mounth_reestr' style='font-size: 10px;'>Количество месяцев</label>
									</div>
									<div class="col-md-2">
								...
								<div class="row ">
									<div class="col-md-2">
										<label style='font-size: 10px;'>Сроки согласования проекта договора исполнителей</label>
									</div>
									<div class="col-md-3">
										<label for='begin_date_reconciliation_reestr' style='font-size: 10px;'>Начало согласования (дата)</label>
									...
									<div class="col-md-3">
										<label for='end_date_reconciliation_reestr' style='font-size: 9px;'>Окончание согласования (дата)</label>
									...
									<div class="col-md-4">
										<label for='count_days_reconciliation_reestr' style='font-size: 10px;'>Общее количество дней согласования</label>
