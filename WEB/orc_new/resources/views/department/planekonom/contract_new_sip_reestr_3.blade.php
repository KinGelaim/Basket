			...
			@if(Auth::User()->hasRole()->role == 'Администратор' OR Auth::User()->hasRole()->role == 'Планово-экономический отдел' OR Auth::User()->hasRole()->role == 'Отдел управления договорами' OR Auth::User()->hasRole()->role == 'Администрация')
				...
				<div class="content">
					<form method='POST' action="{{route('department.ekonomic.create_sip_reestr')}}" file='true' enctype='multipart/form-data'>
						{{csrf_field()}}
						<div style='width: 300px; position: absolute; top: 55px; left: 20px;'>
						...
						<div style='position: absolute; top: 55px; left: 327px;'>
							<div class="form-group">
						...
						<div style='width: 245px; position: absolute; top: 55px; left: 428px;'>
							<div class="form-group">
								<label>Внимание!</label>
								<input class='form-control' style='color:red; text-align:center;' type='text' value='' readonly />
							</div>
						</div>
						<div style='width: 145px; position: absolute; top: 55px; left: 685px;'>
							<div class="form-group">
						...
						<div style='width: 225px; position: absolute; top: 55px; left: 841px;'>
							<div class="form-group">
						...
						<div style='width: 225px; position: absolute; top: 55px; left: 1080px;'>
							<div class="form-group">
						...
						<div style='width: 60px; position: absolute; top: 117px; left: 20px;'>
							<div class="form-group">
						...
						<div style='width: 200px; position: absolute; top: 117px; left: 90px;'>
							<div class="form-group">
						...
						<div style='width: 60px; position: absolute; top: 117px; left: 300px;'>
							<div class="form-group">
						...
						<div style='width: 200px; position: absolute; top: 117px; left: 370px;'>
							<div class="form-group">
						...
						<div style='width: 160px; position: absolute; top: 117px; left: 580px;'>
							<div class="form-group">
						...
						<div style='width: 210px; position: absolute; top: 117px; left: 748px;'>
							<div class="form-group">
						...
						<div style='width: 210px; position: absolute; top: 117px; left: 965px;'>
							<div class="form-group">
						...
						<div style='width: 165px; position: absolute; top: 117px; left: 1182px;'>
							<div class="form-group">
						...
						<div style='width: 165px; position: absolute; top: 175px; left: 20px;'>
							<div class="form-group">
