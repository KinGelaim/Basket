...
@section('title')
	Печать Действующие Договора/Контракты за год (суммы)
@endsection
	...
	<div class="flex-center position-ref full-height">
		@if (Auth::User())
			<div class="">
				<div class='row'>
					<div class="col-md-12">
						<button class='btn btn-primary' id='createExcel' real_name_table='Действующие Договора/Контракты за год (суммы)'>Сформировать Excel</button>
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
						Действующие Договора/Контракты за год (суммы)
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
