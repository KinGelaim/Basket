		...
		@if (Auth::User())
			<div class="">
				...
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
						Итоги по действующим Договорам (Контрактам) на общую сумму
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
							...
							<tr>
								...
								<?php
									...
									foreach($value as $contract){
										...
										}else if($contract->mob_reestr == 1){
											if(is_numeric($contract->amount_contract_reestr))
												$all_mob_reestr += $contract->amount_contract_reestr;
											else if(is_numeric($contract->amount_reestr))
												$all_mob_reestr += $contract->amount_reestr;
