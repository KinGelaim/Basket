...
@section('title')
	Печать Статистический отчет - закуп (по сумме Договора (Контракта))
@endsection
	...
	<div class="flex-center position-ref full-height">
		@if (Auth::User())
			<div class="">
				<div class='row'>
					<div class="col-md-12">
						<button class='btn btn-primary' id='createExcel' real_name_table='Статистический отчет - закуп (по сумме Договора (Контракта))'>Сформировать Excel</button>
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
						Статистический отчет - закуп (по сумме Договора (Контракта))
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
