...
@section('title')
	Печать Список проектов договоров, Договоров вступивших в стлу и их исполнение
@endsection
	...
	<div class="flex-center position-ref full-height">
		@if (Auth::User())
			<div class="">
				<div class='row'>
					<div class="col-md-12">
						<button class='btn btn-primary' id='createExcel' real_name_table='Список проектов договоров, Договоров вступивших в стлу и их исполнение'>Сформировать Excel</button>
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
						Список проектов договоров, Договоров вступивших в силу и их исполнение
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
