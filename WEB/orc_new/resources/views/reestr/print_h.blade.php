...
@section('title')
	Печать Банковские гарантии на {{date('d.m.Y', time())}} г.
@endsection
	...
	<div class="flex-center position-ref full-height">
		@if (Auth::User())
			<div class="">
				<div class='row'>
					<div class="col-md-12">
						<button class='btn btn-primary' id='createExcel' real_name_table='Банковские гарантии на {{date("d.m.Y", time())}} г.'>Сформировать Excel</button>
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
						Банковские гарантии на {{date('d.m.Y', time())}} г.
					</div>
				</div>
				<div class='row' style='text-align: center;'>
					<div class="col-md-12">
