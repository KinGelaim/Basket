...
@section('title')
	Печать Список договор, заключенных в рамках 223-ФЗ, 44-ФЗ
@endsection
	...
	<div class="flex-center position-ref full-height">
		@if (Auth::User())
			<div class="">
				<div class='row'>
					<div class="col-md-2">
						<button class='btn btn-primary' id='createExcel' real_name_table='Список договор, заключенных в рамках 223-ФЗ, 44-ФЗ'>Сформировать Excel</button>
					</div>
				</div>
				<div id='copyTarget'>
					<div class='row' style='text-align: center;'>
						<div class="col-md-12">
							Список договор, заключенных в рамках 223-ФЗ, 44-ФЗ
						</div>
					</div>
					<div class='row' style='text-align: center;'>
						<div class="col-md-12">
					...
					<table id='resultTable' class="table table-bordered" style='margin: 0 auto; margin-top:20px; margin-bottom: 10px;'>
						<thead style='text-align: center;'>
							<tr>
								...
								<th style='text-align: center; vertical-align: middle;' rowspan=2>Цена с НДС, руб.</th>
								<th style='text-align: center; vertical-align: middle;' rowspan=2>Сумма задолженности с НДС, руб.</th>
							</tr>
							<tr>
