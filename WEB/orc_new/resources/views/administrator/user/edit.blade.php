						...
						<div class="col-md-12">
							<form class="form-horizontal" method="POST" action="{{ route('user.update', $user->id) }}">
								...
								<div class="form-group{{ $errors->has('position_department') ? ' has-error' : '' }}">
									...
									<div class="col-md-6">
										<input id="position_department" type="text" class="form-control" name="position_department" value="{{ old('position_department') ? old('position_department') : $user->position_department }}" required>
