...
{
    protected $fillable = ['id_contract_reestr','id_view_contract','amount_contract_reestr','fix_amount_contract_reestr','big_deal_reestr','amount_invoice_reestr','selection_supplier_reestr','type_document_reestr','place_save_contract_reestr', 'date_save_contract_reestr',
							...
							'base_reestr', 'app_outgoing_number_reestr', 'app_incoming_number_reestr', 'result_second_department_date_reestr', 'result_second_department_number_reestr', 
							...
							'okdp_reestr', 'okpd_2_reestr', 'date_bank_reestr', 'amount_bank_reestr', 'bank_reestr', 'date_b_contract_reestr', 'date_e_contract_reestr', 'date_contract_reestr',
							'date_maturity_date_reestr', 'date_maturity_reestr', 'amount_reestr', 'amount_year_reestr', 'amount_contract_year_reestr', 
							'unit_reestr', 'vat_reestr', 'approximate_amount_reestr', 
							'percent_prepayment_reestr', 'prepayment_reestr', 'economy_reestr', 'economy_unit_reestr', 
