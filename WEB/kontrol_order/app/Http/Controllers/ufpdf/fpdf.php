...
function __construct($orientation='P',$unit='mm',$format='A4')
{
	...
	$this->ws=0;
	//Standard fonts
	$this->CoreFonts=array('arialuni'=>'arialuni','courier'=>'Courier','courierB'=>'Courier-Bold','courierI'=>'Courier-Oblique','courierBI'=>'Courier-BoldOblique',
...
function Cell($w,$h=0,$txt='',$border=0,$ln=0,$align='',$fill=0,$link='')
{
	...
	if($txt!='')
	{
		...
		if($this->underline)
			$s.=' '.$this->_dounderline2($this->x+$dx,$this->y+.5*$h+.3*$this->FontSize,$txt);
		if($this->ColorFlag)
			$s.=' Q';
		if($link)
...
function _dounderline2($x,$y,$txt)
{
	//Underline text
