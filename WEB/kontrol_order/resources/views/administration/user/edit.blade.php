						...
						<div class="col-md-12">
							<form class="form-horizontal" method="POST" action="{{ route('user.update', $user->id) }}">
								...
								<div class="form-group{{ $errors->has('position_department') ? ' has-error' : '' }}">
									...
									<div class="col-md-6">
										<input id="position_department" type="position_department" class="form-control" name="position_department" value="{{ old('position_department') ? old('position_department') : $user->position_department }}">
								...
								<div class="form-group{{ $errors->has('telephone') ? ' has-error' : '' }}">
									...
									<div class="col-md-6">
										<input id="telephone" type="telephone" class="form-control" name="telephone" value="{{ old('telephone') ? old('telephone') : $user->telephone }}">
								...
								<div class="form-group{{ $errors->has('login') ? ' has-error' : '' }}">
									...
									<div class="col-md-6">
										...
										@else
											<input id="login" type="login" class="form-control" name="login" value="{{ old('login') ? old('login') : $user->login }}" required readonly >
										@endif
										@if ($errors->has('login'))
											<span class="help-block">
