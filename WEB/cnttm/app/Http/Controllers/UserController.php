...
class UserController extends Controller
{
    ...
    {
		$users = User::select(['users.id','users.surname','users.name','users.patronymic','roles.role','users.email','users.deleted_at'])->join('roles','users.id_role','roles.id')->withTrashed()->get();
	...
	public function update_email(Request $request, $id)
	{
		...
		if(Auth::User()->id == $id)
		{
			...
			$user->save();
			return redirect()->back()->with('success','Адрес успешно изменен!');
		}
